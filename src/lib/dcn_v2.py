"""PyTorch 2-compatible DCNv2 interface for the upstream FairMOT DLA decoder.

The upstream project imports its PyTorch-1.7 CUDA extension as ``dcn_v2``.
This adapter preserves the module API with torchvision's compiled deformable
convolution operator.  It is an environment compatibility layer and does not
change the FairMOT architecture, loss, or association policy.
"""
